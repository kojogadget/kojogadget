...
| Project | Description |
|---------|-------------|
| [nvim-config](https://github.com/kojogadget/nvim-config) | Personal Neovim setup (Lua) |
| [kojoeditor](https://github.com/kojogadget/kojoeditor) | Minimal text editor written in Go |
| [surgical-blood-loss](https://github.com/kojogadget/surgical-blood-loss) | Data collection site for a master's research study |

---

*Outside of code: husband, dad of two, and occasional tinkerer.*
